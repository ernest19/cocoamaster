...
import 'package:cocoa_master/view/utils/capitalize_string.dart';
                ...
                child: Stack(
                  children: [
                    GoogleMap(
                      ...
                      zoomControlsEnabled: widget.viewOnlyMap! ? true : false,
                  ...
                  children: [
                    if (pickingPoints == true &&
                      ...
                      widget.viewOnlyMap!
                          ...
                          : CustomButton(
                              isFullWidth: true,
                              backgroundColor: (double.parse(currentPosition
                                              ?.accuracy
                                              .toString() ??
                                          '100.0') <=
                                      widget.maxAccuracy!)
                                    ...
                                    onLocationEnabled:
                                      ...
                                      if (isEnabled == true) {
                                        if (widget.persistMaxAccuracy == true) {
                                          if (double.parse(currentPosition
                                                      ?.accuracy
                                                      .toString() ??
                                                  '100.0') <=
                                              widget.maxAccuracy!) {
                              ...
                              child: Text(
                                'Record a point',
                                style: TextStyle(
                                    color: (double.parse(currentPosition
                                                    ?.accuracy
                                                    .toString() ??
                                                '100.0') <=
                                            widget.maxAccuracy!)
